# Reference 1 : https://github.com/tensorflow/docs/blob/master/site/en/r1/tutorials/estimators/cnn.ipynb
# Reference 2 : https://github.com/kubeflow/examples
# Reference 3 : https://www.tensorflow.org/api_docs/python/tf/keras/datasets/cifar10/load_data
...
def conv_model(features, labels, mode, params):
  ...
  logits = tf.layers.dense(h_fc1, n_images, activation=None)
...
def main(_):
  ...
  cifar = tf.contrib.learn.datasets.DATASETS['cifar10'](args.tf_data_dir)
  train_input_fn = tf.estimator.inputs.numpy_input_fn(
      x={X_FEATURE: cifar.train.images},
      y=cifar.train.labels.astype(np.int32),
